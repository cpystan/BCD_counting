...
parser = argparse.ArgumentParser(description='Lym_counting')
...
parser.add_argument('--mode', type=str, default='train',
                    help='train or test')
parser.add_argument('--is_checkpoint', type=str, default='False',
                    help='whether load from checkpoint')
parser.add_argument('--check_path', type=str, default='False',
...
parser.add_argument('--n_GPUs', type=int, default=1,
                    help='number of GPUs')
parser.add_argument('--set_gpu', type=str, default='6',
                    help='which gpu to deploy')
parser.add_argument('--seed', type=int, default=1,
                    help='random seed')

# Data specifications
parser.add_argument('--data_train', type=str, default='/data2/Public_dataset/Public_Lymphocyte_Assessment_Hackatho/training.h5',
                    help='train dataset')
parser.add_argument('--data_test', type=str, default='/data2/Public_dataset/Public_Lymphocyte_Assessment_Hackatho/test.h5',
                    help='test dataset')
parser.add_argument('--crop_edge_size', type=int, default=288,
                    help='crop edge size')
